...
def getInsertQuery(master_id:str):
    ...
    query += " CAST(now() AS DATE) AT TIME ZONE 'UTC' AT TIME ZONE 'Asia/Tokyo' AS datetime"
    query += " )"
    ...
    query += " FROM td3 LEFT JOIN td2 ON td3.master_id=td2.master_id AND td3.datetime=td2.datetime"
